@if ($paginator->hasPages())
    <ul class="pagination">
        ...
        @if ($paginator->onFirstPage())
            <li class="page-item disabled"><span class="page-link"><i class="fas fa-caret-left"></i></span></li>
        @else
        ...
        @else
            <li class="page-item disabled"><span class="page-link"><i class="fas fa-caret-right"></i></span></li>
        @endif
    </ul>
@endif
